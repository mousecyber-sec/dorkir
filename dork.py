...
def cek():
	...
	for url in finallist:
		print (R+"[!] "+G+"Scanning Vulnerability..\r"),;sys.stdout.flush()
		EXT = "'"
		host = url+EXT
		try:
	...
	if len(hasil) == 0:
		...
		print (W+43*"-")
		print (R+"[!] "+Y+"Saving web.."),;sys.stdout.flush()
		for x in hasil:
			vuln.write(x+"\n")
		vuln.close()
        ...
        print (B+"\r[*] "+G+"Total web "+W+": %s "%(len(hasil)))
	print (W+43*'-'+'\n')
...
def cari(inurl , site , maxc):
    ...
    print (R+"[!] "+Y+"Please Wait.."+glp),;sys.stdout.flush()
...
if __name__ == "__main__":
	print (R+" ___           _   ")
	print (R+"|    \ ___ ___| |________ ")
	print (W+"|  |  | . |  _| '_|_|  __|")
	print (W+"|____/|___|_| |_,_|_|_|"+R+" (MOUSE CYBER SCRTY)")
	print (G+43*"-")

	inurl = raw_input(B+"[?]"+R+" Inurl    "+W+": ")
	site  = raw_input(B+"[?]"+R+" Site     "+W+": ")
	maxc  = raw_input(B+"[?]"+R+" Page     "+W+": ")
